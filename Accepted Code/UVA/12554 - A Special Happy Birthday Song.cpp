...
/****************************Implementation************************/
char names[103][103];
char words[][103] = {"Happy","birthday", "to","you", "Happy", "birthday", "to", "you", "Happy" ,"birthday","to", "Rujia", "Happy" ,"birthday", "to" , "you"};
int main()
{
    int n;
    while(sc(n)!= EOF)
    {
        ...
        int noOfTimes = (n/16+ !(!(n%16)))*16 ;

        for(int i = 0 ; i< noOfTimes ; i++ )
        {
            printf("%s: %s\n",names[i%n], words[wordsPointer%16]);
            wordsPointer ++ ;
        }
